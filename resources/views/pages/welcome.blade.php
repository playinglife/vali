...
@section('content')
    ...
    <div class="root-views-welcome">
        ...
        <!-- Page 1 -->
        <div class="page-1">
            <h1> {{ __('pages.welcome.title1') }} </h1>
        </div>

        <x-miniviews.section type="one">
            <x-slot:title>
                {{ __('pages.welcome.subtitle1') }}
            </x-slot:title>
            <x-slot:text>
                {{ __('pages.welcome.text1') }}
            </x-slot:text>
        </x-miniviews.section>

        <x-miniviews.section type="two"> 
            <x-slot:title> {{ __('pages.welcome.subtitle2') }} </x-slot:title>
            <x-slot:text>
                {{ __('pages.welcome.text2') }}
            </x-slot:text>
        </x-miniviews.section>


        <div class="page-2">
            <h1> {{ __('pages.welcome.title2') }} </h1>
        </div>

        <x-miniviews.section type="one">
            <x-slot:title> {{ __('pages.welcome.subtitle3') }} </x-slot:title>
            <x-slot:text>
                {{ __('pages.welcome.text3') }}
            </x-slot:text>
        </x-miniviews.section>
